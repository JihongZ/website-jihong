...
pubs <- pubs |> 
  ...
  mutate(publication_pdf_path = paste0("publications/", year, "/",str_replace(title, ":", "_"), ".pdf")) |> # generate the path for pdf
  mutate(
    pubs_formated = paste0(str_replace(pubs_formated, 
                                       title, 
                                       paste0("[", title, "](", publication_pdf_path, ")")))
  ) |> 
