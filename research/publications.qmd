...
plot_ly(data = pubs_count_ts) |> 
  add_trace(x=~year, y=~n, mode = "lines+markers", color = I("maroon"), name = "Current Number") |> 
  add_trace(x=~year, y=~n_cum, mode = "lines+markers", color = I("darkseagreen"), name = "Cumulative Number") |> 
  layout(
