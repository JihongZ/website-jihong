...
::: notes
In the future, AI will be invoved into psychometric studies, such as AI scoring, item generation, automate assessment.
:::
----


## AI conversational assessment: One in-class quiz example {visibility="hidden"}
