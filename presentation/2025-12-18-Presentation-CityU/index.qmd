...
::: {.discussion}
1. Illustrate the conceptual foundations of network 

2. Demonstrate two empirical case studies:
...
3. Conclude with emerging innovations in AI-augmented psychometric research
:::
...
![](figures/bayesian_network_example.webp)
:::
...
:::
::: column
5.  **Psychological Network Analysis** (Psychopathology, Psychology)
:::
::::
...
![Exploratory factor analysis and psychological network analysis of Big Five personality (Borsboom et al., 2021)](/teaching/2024-01-12-syllabus-adv-multivariate-esrm-6553/Images/Lecture12_Network/GGM.png)
...
# Case Study: A longitudinal Electroencephalography (EEG) network analysis 

![](figures/eeg-private.jpg)
...
-   **Sample**: 19 participants completed 8 weeks of F training with 3 visits per week, resulting in 24 sessions.
...
- **Brain region (topography) matters** 
    ...
    2. Posterior theta power enhances mindfulness, while temporal-cental theta power suppresse mindfulness
...
-   But, can we use it to understand the complex mental disorders? Symptom network seems a very interesting idea.
:::

# Case Study: Gender Differences for Eating Disorder Symptom Networks
...
-   Is there any other novel psychometric areas? AI-driven psychometrics.
:::
