...
-   **Measure**: Self-reported State Mindfulness Scale (SMS_Mind) and mind (SMS_Body)

![Self-reported State Mindfulness Scale Scores over 24 sessions](figures/Test2_SMSBody_Trend.jpg){width=100%}
...
-   [2 State Mindfulness Nodes]{.bigger}
...
-   [6 EEG Nodes]{.bigger}: **Alpha** (8-12 Hz; relaxed wakefulness) and **Theta** (4-8 Hz; light sleep) power separated across respective frontal, temporal-central, and posterior regions
    
    - [frontal]{.redcolor} alpha
    - [frontal]{.redcolor} theta
    - [temporal-central]{.bluecolor} alpha
    - [temporal-central]{.bluecolor} theta
    - [posterior]{.green style="background:yellow"} alpha
    - [posterior]{.green style="background:yellow"} theta
...
[Unregularized]{.bluecolor} psychological network
...
[Regularized]{.redcolor} psychological network
...
[Alpha power]{style="color:pink"}; [Theta power]{style="color:blue"}; [Self-report mindfulness]{style="color:green"}
:::
...
- **Brain region (topography) matters** 
    ...
    1. Frontal alpha power enhances mindfulness, while posterior alpha power suppresses mindfulness of body and mind over time.
    
    2. Posterior theta power enhances mindfulness, while yemporal-cental theta power suppresse mindfulness

-   **Identify ideal brain states**

    1. According to centraliy measures, front apha and posterior theta are most important EEG signal for FA mediation training.
:::
::::: 
...
::: discussion
- [Advantages of longitudinal network]{.bigger}
...
AI-enhanced psychometrics is becoming more and more importance.
