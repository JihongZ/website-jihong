...
# Case Study 1: A longitudinal Electroencephalography (EEG) network analysis 
...
:::
::: column
3.  **Topographical patterns**: Multiple brain regions (frontal or posterior) form interconnected systems
<br>
4.  **Temporal changes**: Allow us to track Longitudinal effects which indicates brain network activities developing with meditation training
:::
::::
:::
...
:::
::: column
![](figures/Meditation-man-meditating-1536x865.jpeg)
:::
::::
...
# Case Study 2: Gender Differences for Eating Disorder Symptom Networks
