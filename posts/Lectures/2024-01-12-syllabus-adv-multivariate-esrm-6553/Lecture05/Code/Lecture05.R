...
library(bayesplot)
## Read in data
dat <- read.csv(here::here("posts", "Lectures", "2024-01-12-syllabus-adv-multivariate-esrm-6553", "Data", "DietData.csv"))
...
##
mod_full_new <- cmdstan_model(here::here("posts", "Lectures", "2024-01-12-syllabus-adv-multivariate-esrm-6553", "Lecture04", "Code", "FullModel_New.stan"))
...
### PPP-values in Stan
mod_full_ppp <- cmdstan_model(here::here("posts", "Lectures", "2024-01-12-syllabus-adv-multivariate-esrm-6553", "Lecture05", "Code", "FullModel_PPP.stan"))
...
mod_empty_ppp <- cmdstan_model(here::here("posts", "Lectures", "2024-01-12-syllabus-adv-multivariate-esrm-6553", "Lecture03", "Code", "EmptyModel.stan"))
...
save(dat, data_full_new, mod_full_ppp, fit_empty_ppp, fit_full_new, fit_full_ppp, WAIC_full, WAIC_empty, LOO_full, LOO_empty,
  ...
  file = here::here("posts", "Lectures","2024-01-12-syllabus-adv-multivariate-esrm-6553", "Lecture05", "Code", "Lecture05.RData")
)
