...
3.  Understand the relationship between psychometric/psychological network with factor analysis

4.  Understand how network model can be applied into real scenarios
...
- CFA constraints remove rotational indeterminacy of factor loadings – no
rotating is needed (or possible)
Ø Defines factors with potentially less ambiguity
w Constraints are easy to see
Ø For some software (SAS and SPSS), we get much more model
fit information
