...
-   **Question**: Maximum Likelihood Estimation belongs to [2ed type]{.mohu}
:::
...
$$
L(\beta_1=1 | \beta_0 = 0, \sigma^2_e = 1) = \frac{1}{\sqrt{2\pi*\color{tomato}{1}}}\exp(-\frac{(112-\color{royalblue}{(0+1*112)})^2}{2*\color{tomato}{5}})
$$
...
`{r}} Residual standard error: 2.059126  Degrees of freedom: 5 total; 4 residual`
