...
# Unit 2: Main Effects Within Interactions
...
Paste your R syntax that can calculate the other two groups' (Senior-Old, Senior-New) standard errors. . For example for Freshman-New:
...
> Var_Test_2 \<- Var_beta_0 + Var_beta_2 + 2\*Cov_beta_0_2
>
> (SE_Test_2 \<- sqrt(Var_Test_2)) \[1\] 0.5364078
:::

## Mapping Results to Data

-   Conditional main effect of Senior (Senior vs. Freshmen) when using the new method (New = 0)
