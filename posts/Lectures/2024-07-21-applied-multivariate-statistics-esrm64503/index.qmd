...
+:=====+:======+:====================================================================================+:==========================================================================================================================================+:==============+===========+
| 1    | 08/19 | [Introduction and Overview; Introduction to R and Rstudio](Lecture01/Lecture01.qmd) | [*dplyr*](https://dplyr.tidyverse.org/) get started                                                                                       | -   HW0[^1]   |           |
|      |       |                                                                                     |                                                                                                                                           |               |           |
...
|      |       |                                                                                     |                                                                                                                                           |               |           |
|      |       |                                                                                     | [Venables et al. (2013)](https://cran.r-project.org/doc/manuals/R-intro.pdf)                                                              |               |           |
+------+-------+-------------------------------------------------------------------------------------+-------------------------------------------------------------------------------------------------------------------------------------------+---------------+-----------+
...
|      |       |                                                                                     |                                                                                                                                           |               |           |
|      |       |                                                                                     | 1.  [Ch.5: Specification](Materials/Kline%20(2005)%20Ch.5.pdf)                                                                            | ```{=html}    |           |
