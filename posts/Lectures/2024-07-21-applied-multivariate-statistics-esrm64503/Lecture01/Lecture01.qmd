...
-   **Why not Python, Julia, STAT or other software (e.g., matlab)?**
    ...
    -   They are not so popular in the relevent fields of educational statistics, which means you cannot get much support from the community.
...
-   **Hold on**. There are something to consider
...
::: {.column width="50%"}
![Word Cloud of MVA wiki](figures/wordcloud.png){fig-align="left" width="800"}
:::
:::
...
-   **Part I: General linear models**
    ...
    -   Generalized linear regression predicting non-normal conditional outcomes
...
![](figures/terminal.png){fig-align="left" width="1137"}

## Rstudio

![](figures/Rstudio.png){fig-align="left" width="1282"}
:::
...
-   R packages are uploaded to some platforms (i.e., CRAN or Github) by researchers or companies
    ...
    -   Do not upgrate your packages if you code is running well
...
-   To operate certain tasks, you need to use functions contained in R packages
    ...
    -   ![](figures/function.png){width="1067"}
...
-   Let me use [Homework 0](https://jihongzhang.org/posts/Lectures/2024-07-21-applied-multivariate-statistics-esrm64503/HWs/HW_demo.html) as example.
