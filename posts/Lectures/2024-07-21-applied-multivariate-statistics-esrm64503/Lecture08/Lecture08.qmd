...
## Model 2: Adding One More Variable: Multivariate Regression
...
-   **Research Question**: Whether or not students' performance are related to their perceived usefulness of mathematics?
...
## Model 2: Simplest Multivariate Model

**Aim**: To untangle the simple correlation between `perf` and `use`

Number of parameters is 5, including two variables' means and three variance-and-covaraince components.
...
## Print output
summary(model02.fit)
lavaan::standardizedsolution(model02.fit)
```
...
1.  Use `lavaan` and `dataMath` to test the correlations among Math Performance, Math Anxiety, and Perceived Usefulness of Mathematics (USE).
    ...
    -   **Q9:** Provide evidence of significance testing for the model comparison between Model 1 and Model 2. Write down your conclusion about which model is better and whether the difference is significant.
