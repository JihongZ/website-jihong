...
1. **Question**: Use `lavaan` to test the correlations among Math Performance, Math Anxiety, and Perceived Usefulness of Mathematics (USE).

    -   Model 1: All correlations are freely estimated.
    -   Model 2: Fix the correlation between math anxiety and perceived usefulness of mathematics to 0; Leave the other correlations to be freely estimated.
