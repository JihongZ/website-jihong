...
ggplot(total_summary, aes(x = School)) +
  geom_point(aes(y = Mean_Grade_byTutor, color = Tutoring)) +
  geom_hline(aes(yintercept = Mean_Grade_byTutor, color = Tutoring)) +
...
ggplot(total_summary, aes(x = Tutoring)) +
  ...
  geom_hline(aes(yintercept = Mean_Grade_bySchool, color = School)) +
  scale_y_continuous(limits = c(70, 90), breaks = seq(70, 90, 5)) +
...
ggplot(data = combined_vis_data, aes(x = School_Levels)) +
  geom_path(aes(y = as.numeric(Line_No_Tutor)), group = 1, color = "red") +
  geom_path(aes(y = as.numeric(Line_Once_A_Week)), group = 1, color = "green") +
  geom_path(aes(y = as.numeric(Line_Daily)), group = 1, color = "blue") +
