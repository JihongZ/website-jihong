...
1.  **Post-test Only Design** - Features: control vs. treatment, randomly assigned
    -   [x] Neither group is pre-tested before treatment
...
![](images/clipboard-1065141229.png){width="100%"}

## 1. Statistical Conclusion Validity (I)
...
## 1. Statistical Conclusion Validity (II)
