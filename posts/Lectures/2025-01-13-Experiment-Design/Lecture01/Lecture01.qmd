...
3.  Walk you through the syllabus

    1.  How to have access to syllabus

    2.  Basic information of this course

    3.  Goal of this course

    4.  Delivery method of class materials

    5.  Assignments

    6.  Weekly schedule

4.  Brief Introduction to R

## Self Introduction

::: {.columns .column-screen}
::: {.column width="33%"}
![Master, University of Kansas (2015-2019)](figures/school_ku.png){fig-align="center" width="73%"}
:::

::: {.column width="33%"}
![PhD, University of Iowa (2019-2022)](figures/school_ui.png){fig-align="center" width="73%"}
:::
...
## What is Experimental Design in Education?

1.  In education? No, applied to other areas, such as psychology, finance, biology
2.  Focus on the statistical thinking to test the hypothesis
3.  Be flexible to the class example. Cover traditional statistical thinking as well as cutting-edge statistical methods. For example, machine learning and AI.

## About this class

-   No examination or class project

-   Office hours will be 2pm to 4pm just before class

-   Light assignment load: 3-5 assignments with multiple-choice questions and light calculations

-   To teach big picture and general directions rather than technical details of statistical methods

    -   But some software tools will be taught

-   All materials use R

## Introduce to yourself

-   Let's get familiar to each other. Tell me:

    1.  Your name
    2.  Department name and Which year in your program
    3.  Why you are interested in Experimental design

## Class Time

1.  Unit 1 (17:00 - 17:45): Lectures about concepts
2.  Unit 2 (18:00 - 18:45): Illustrate relevant Examples
3.  Unit 3 (19:00 - 19:45): Practice with R Code by yourself and Ask Questions

## Course Philosophy 

-   **Philosophy**: Focus on accessibility + learning-by-doing

    -   This class heavily emphasize on hands-on task-oriented practices
...
-   **Materials:**
    ...
    -   **Lecture** slides present concepts—the **what** and the **why**
        ...
        -   Slides can be displayed as html by clicking the link in the weekly schedule table on the course webpage

        -   You can print it out by press `e` and then press `Cmd/Ctrl + p`; Select `Save to PDF`

    -   **Example** documents: reinforce the concepts and demonstrate the **how** using software—R packages

        -   Examples will be displayed as html. Code and syntax can be copied and pasted.
...
1.  [Online Microsoft form]{.underline}
2.  Exercise: Use the Homework Portal
...
-   **Attendance**: Strongly recommended but not required
    ...
    -   **Please do not attend** if you might be sick!
