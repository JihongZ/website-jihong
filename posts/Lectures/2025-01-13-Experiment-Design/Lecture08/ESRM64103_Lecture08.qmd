...
- **Background**: Testing new fertilizers in different types of crops. Crops are divided into 3 different types (blocks). These blocks are again divided into 3 fertilizers that are used on those crops. The figure for this is as follows:
