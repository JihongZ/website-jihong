...
Network psychometrics is a novel area thaat allows representing complex phenomena of measured constructs in terms of a set of elements that interact with each other.

It arises as [psychological phenomena]{.underline} such as individual differences in psychopathology and personality is getting much more complex.
...
## Varied Perspectives between Network and Common Factor
...
-   unavoidable cycle of "fatigue -\> worring -\> insomnia -\> fatigue" will leads to higher "depression"
...
::: columns
::: {.column width="50%"}
![](../Images/Lecture12_Network/girls_betweensubject_MG.jpg){width="70%"}
:::
