...
library(kableExtra)
library(psych)
dat_path <- '~/Documents/Projects/website-jihong/posts/2024-01-12-syllabus-adv-multivariate-esrm-6553/Lecture07/Code'
...
Then, iter-item correlation and Cronbach alpha can be computed as:
