---
title: "How to set up High Performance Computing"
...
**Second**, create a job file with `.sh` or `.slurm` extension. Here's a simple example of a job file `example.sh` that can tell HPC **how** to run your R code:
...
## One example for parallelization of Stan
...
![Workflow for HPC Job](Workflow.png){fig-align="center"}
...
```{r, echo=FALSE}
xfun::embed_file("Procedure of Data Analysis on HPC.pdf")
```

## Resources

1.  Linux 101: <https://github.com/erolrecep/GettingStartedwithAHPCC>
2.  [New Mexico State University HPC Wiki](https://hpc.nmsu.edu/discovery/slurm/)
3.  [Slurm Official Documentation](https://slurm.schedmd.com/documentation.html)
4.  [University of Arkansas HPC Center Wiki](https://hpcwiki.uark.edu/doku.php?id=pinnacle_usage) (not very useful and outdated)
5.  [Slides fo Jobs Submission in Slurms by Damien Francios](https://indico.cism.ucl.ac.be/event/121/contributions/60/attachments/130/287/slurm2022.pdf)
