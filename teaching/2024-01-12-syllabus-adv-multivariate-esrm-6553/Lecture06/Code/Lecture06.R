if (0) {
  load(here::here("teaching","2024-01-12-syllabus-adv-multivariate-esrm-6553", 
                  "Lecture06", "Code", "Lecture06.RData"))
}
root_dir <- here::here("teaching","2024-01-12-syllabus-adv-multivariate-esrm-6553", "Lecture06", "Code")
...
#     file = here::here("teaching","2024-01-12-syllabus-adv-multivariate-esrm-6553", 
#                       "Lecture06", "Code", "Lecture06.RData")
#)
