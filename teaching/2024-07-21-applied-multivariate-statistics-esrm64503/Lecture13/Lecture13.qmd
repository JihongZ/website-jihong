...
![Factor Analysis and Psychological Network (Borsboom et al., 2021)](/teaching/2024-01-12-syllabus-adv-multivariate-esrm-6553/Images/Lecture12_Network/GGM.png){#fig-GGM}
:::
...
::: {.column width="50%"}
![](/teaching/2024-01-12-syllabus-adv-multivariate-esrm-6553/Images/Lecture12_Network/girls_contemporaneous_MG.jpg)
:::
:::
...
::: columns
::: {.column width="50%"}
![Emotion regulation (Awareness), Interpersonal problems and eating disorder](/teaching/2024-01-12-syllabus-adv-multivariate-esrm-6553/Images/Lecture12_Network/girls_betweensubject_MG.jpg){fig-align="center"}
:::
...
::: columns
::: {.column width="60%"}
![](/teaching/2024-01-12-syllabus-adv-multivariate-esrm-6553/Images/Lecture12_Network/workflow.png){fig-align="center"}
:::
...
We can get partial correlation matrix $R$ from the precision matrix $K$ and the correlation matrix `Sigma`.
