...
- **Answer**: <span class="mohu">It is {1, 1} for maximum and minimum temperatures because they are two separate random variables.</span>
...
- We can check this assumption by examining the residuals:
...
In practice, tests will often provide conflicting information.
The best way to evaluate normality is to consider both plots and tests together (approximate normality is usually sufficient)
