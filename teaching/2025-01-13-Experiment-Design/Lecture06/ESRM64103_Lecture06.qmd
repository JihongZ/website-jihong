...
-   Brief intro to different types of experimental design
-   Validity
-   In-class AI quiz
...
-   **Pre-test:** Researchers measure _recycling rates_ in a city.
-   **Treatment:** The public health campaign runs for 3 months.
-   **Post-test:** Researchers measure _recycling rates_ again and find a significant increase.
...
- Click [here](https://chatgpt.com/g/g-68dd5654a88081918d705a6a7d9d705a-ai-assistant) to start AI assessment
  
  - Log in your OpenAI account
  
  - Use "Let's start the quiz." to start the in-class quiz.
  
  - This is a testing. The score will not be your actual grade.
  
- Click [here](https://forms.gle/JACn2wBYCJYzZiLM9) to finish the feedback survey
