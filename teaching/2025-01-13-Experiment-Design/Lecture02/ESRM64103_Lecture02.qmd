...
We can classify the statistics regarding its purposes:
...
**To perform inferential statistics, we need to go through following steps:**
...
-   [A political scientist is interested in politicians’ attitudes toward tax reform and conducts a survey of Republicans, Independents, and Democrats.]{.underline}
...
1.  Formulate the null hypothesis (𝐻₀) and the alternative hypothesis (𝐻ₐ)
    ...
    -   Example: Investigating whether political groups affect their attitudes.
        ...
        -   Hypothesis: "[**Different political groups will show varied attitudes.**]{.underline}"
...
2.  When we conduct a hypothesis testing, these four cases might be occurred
...
1.  p-values: the probability of observing data as extreme as, or more extreme than, the data observed [under the assumption that the null hypothesis is true]{.underline}.
    ...
    -   Question: Given that we already have the observed data, does **lower p-values means the null hypothesis is unlikely to be true**, which is our goal for inferential statistics?
