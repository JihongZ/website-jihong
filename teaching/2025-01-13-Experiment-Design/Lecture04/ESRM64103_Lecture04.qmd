...
print(lmtest::dwtest(score ~ group, data = dat1))
print(lmtest::dwtest(score ~ group, data = dat2))
```
...
Other multicomparison methods allow you to choose which method to adjust p-values.
