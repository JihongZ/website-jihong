...
#show: doc => article(
  ...
  authors: (
    ( name: [Jihong Zhang],
      affiliation: [Educational Statistics and Research Methods (ESRM) Program\*
...
+ #link("https://forms.office.com/Pages/ResponsePage.aspx?id=DQSIkWdsW0yxEjajBLZtrQAAAAAAAAAAAANAAbGr9vVUQlNUUjFTQ09ISU1WODM1QzZDRlZLR0xZTS4u")[Homework 1]
+ #link("https://forms.office.com/Pages/ResponsePage.aspx?id=DQSIkWdsW0yxEjajBLZtrQAAAAAAAAAAAANAAbGr9vVUM1Q2RkxUTkQ4UEcySENMNFAxQUlMSFJIWi4u")[Homework 2]
+ Homework 3
...
#figure(
  align(center)[#table(
    ...
    table.hline(),
    [1], [01/13], [#link("Lecture01/ESRM64103_Lecture01.qmd")[Lec1: Welcome to ESRM 64103]
    ...
    [6], [02/17], [#link("Lecture05/ESRM64103_Lecture05.qmd")[Lec5: Comparison and Contrast]

    Data: #link("Lecture05/week5_example.csv")[week5\_example.csv]

    ], [#link("https://forms.office.com/Pages/ResponsePage.aspx?id=DQSIkWdsW0yxEjajBLZtrQAAAAAAAAAAAANAAbGr9vVUM1Q2RkxUTkQ4UEcySENMNFAxQUlMSFJIWi4u")[HW\#2]

    Due on 02/24 5PM

    ],
    [7], [02/24], [#link("Lecture06/ESRM64103_Lecture06.qmd")[Lec6: Validity];], [#link("Lecture05/HW2_Answer.qmd")[HW\#2 Answer];],
    [8], [03/03], [#link("Lecture07/ESRM64103_Lecture07.qmd")[Lec7: Blocking design (1)];], [],
    [9], [03/10], [#link("Lecture08/ESRM64103_Lecture08.qmd")[Lec8: Blocking design (2)]

    #link("Lecture08/exp1_data.csv")[exp1\_data.csv]

    #link("Lecture08/tip_hardness.csv")[tip\_hardness.csv]

    ], [],
    [10], [03/17], [#link("Lecture09/ESRM64103_Lecture09.qmd")[Lec9: 2-Way ANOVA (1)];], [],
