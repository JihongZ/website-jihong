...
-   Incorporates information on additional variables (e.g., motivation) directly into the model.
    -   **To estimate differences in math word‑problem performance as if the groups were equivalent in baseline motivation** (or experience, etc.).
-   When comparing groups, we claim that people vary in their scores on the DV for a variety of reasons:
    ...
    -   **Individual Differences** - Ex: Motivation to do well on the math test
