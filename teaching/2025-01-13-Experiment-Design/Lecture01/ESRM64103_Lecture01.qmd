...
2.  [The syllabus](../ESRM64103_syllabus_Spring2026.qmd)
...
![][1]
  ...
  [1]: images/clipboard-2403214329.png
...
-   Light homework load, 3-5 assignments with multiple-choice questions and light calculations
...
3.  to provide the broad picture of one of the most popular research design - group comparisons
  ...
  [Graduate Certificate in Educational Statistics and Research Methods]: https://esrm.uark.edu/certificates/statistics-research-methods.php
...
4.  [Elective]{.underline}: **ESRM 64503 — Applied Multivariate Statistics**: Extend analysis to multiple dependent and independent variables.
5.  [Elective]{.underline}: **ESRM 65203 — Structural Equation Modeling**: Develop expertise in complex model testing.
...
4.  [Elective]{.underline}: **ESRM 66503 — Measurement and Evaluation**: Focus on assessment and evaluation techniques.
5.  [Elective]{.underline}: **ESRM 67503 — Item Response Theory**: Specialize in modern test theory applications.
...
-   **Up to 80 points** can be earned from homework assignment **(3\~4 assignments in total)**
...
-   **Late Assignment**:
    ...
    -   Assignments submitted any time after the deadline will incur a **4-point penalty**. However, extensions will be granted as needed for extenuating circumstances (e.g., conferences, comprehensive exams, family obligations) if requested at least two weeks in advance of the due date.

## Homework Delivery Format

:::: columns
::: column
1.  [Online google form]{.underline}
:::

::: column
![](images/homework_screenshot.png)
:::
::::
...
::::::
  ...
  [2]: figures/terminal.png {fig-align="left" width="100%"}
  [3]: figures/Rstudio.png {fig-align="left" width="100%"}
  [4]: figures/VsCode.png {fig-align="left" width="100%"}

## RStudio User Interface

![][5]

  [5]: figures/Rstudio_labelled.png {fig-align="left" width="100%"}
...
-   After installation of R and RStudio, you can open up the RStudio to start your R programming.
  ...
  [6]: https://download1.rstudio.org/electron/windows/RStudio-2024.04.2-764.exe
  [7]: https://download1.rstudio.org/electron/macos/RStudio-2024.04.2-764.dmg
...
-   To operate certain tasks, you need to use functions contained in R packages
  ...
  [8]: figures/function.png {width="100%"}
