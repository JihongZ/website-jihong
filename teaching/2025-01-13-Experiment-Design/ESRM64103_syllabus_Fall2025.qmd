...
![][1]
  ...
  [1]: images/logo_ESRM64103.png {fig-align="center" width="512"}
...
-   Semester: Fall 2025
  ...
  [jzhang\@uark.edu]: mailto:jzhang@uark.edu
...
4.  Homework 3
  ...
  [Homework 0: Demo]: https://forms.office.com/r/v5QU6KMgXc
...
+------------+------------+-----------------------------------+--------------------+
| 2          | 08/27      | Lec1 (Online): [R programming]    | HW#1               |
|            |            |                                   |                    |
|            |            | [heights.csv]                     | Due on 09/03 Noon  |
|            |            |                                   |                    |
|            |            | [wide.sav]                        |                    |
|            |            |                                   |                    |
|            |            | [ExtraCode.R]                     |                    |
+------------+------------+-----------------------------------+--------------------+
| 3          | 09/03      | [Lec2: Hypothesis testing]        | HW#1 Answer        |
+------------+------------+-----------------------------------+--------------------+
| 4          | 09/10      | [Lec3: One-way ANOVA]             |                    |
+------------+------------+-----------------------------------+--------------------+
| 5          | 09/17      | [Lec4: ANOVA Assumption Checking] |                    |
+------------+------------+-----------------------------------+--------------------+
| 6          | 09/24      | [Lec5: Comparison and Contrast]   | HW#2               |
|            |            |                                   |                    |
|            |            | Data: [week5_example.csv]         | Due on 10/01 Noon  |
+------------+------------+-----------------------------------+--------------------+
| 7          | 10/01      | [Lec6: Validity]                  | HW#2 Answer        |
+------------+------------+-----------------------------------+--------------------+
| 8          | 10/08      | [Lec7: Blocking design (1)]       |                    |
+------------+------------+-----------------------------------+--------------------+
| 9          | 10/15      | [Lec8: Blocking design (2)]       |                    |
|            |            |                                   |                    |
|            |            | [exp1_data.csv]                   |                    |
|            |            |                                   |                    |
|            |            | [tip_hardness.csv]                |                    |
...
: Weekly Schedule {tbl-colwidths="\[10,10,45,20\]"}
  ...
  [Lec1: Introduction and Overview]: Lecture01/ESRM64103_Lecture01.qmd
  [Homework 0: Demo]: https://forms.office.com/r/v5QU6KMgXc
  [R programming]: Lecture01/MakeFriendsWithR.qmd
  [heights.csv]: Lecture01/heights.csv
  [wide.sav]: Lecture01/wide.sav
  [ExtraCode.R]: Lecture01/ExtraCode.R
  [Lec2: Hypothesis testing]: Lecture02/ESRM64103_Lecture02.qmd
  [Lec3: One-way ANOVA]: Lecture03/ESRM64103_Lecture03.qmd
  [Lec4: ANOVA Assumption Checking]: Lecture04/ESRM64103_Lecture04.qmd
  [Lec5: Comparison and Contrast]: Lecture05/ESRM64103_Lecture05.qmd
  [week5_example.csv]: Lecture05/week5_example.csv
  [Lec6: Validity]: Lecture06/ESRM64103_Lecture06.qmd
  [Lec7: Blocking design (1)]: Lecture07/ESRM64103_Lecture07.qmd
  [Lec8: Blocking design (2)]: Lecture08/ESRM64103_Lecture08.qmd
  [exp1_data.csv]: Lecture08/exp1_data.csv
  [tip_hardness.csv]: Lecture08/tip_hardness.csv
  [Lec9: 2-Way ANOVA (1)]: Lecture09/ESRM64103_Lecture09.qmd
  [Lec10: 2-Way ANOVA (2)]: Lecture10/ESRM64103_Lecture10.qmd
  [Lec11: Repeated Measure ANOVA]: Lecture11/ESRM64103_Lecture11.qmd
  [Lec12: ANCOVA]: Lecture12/ESRM64103_Lecture12.qmd
  [Lec13: Mixed ANOVA]: Lecture13/ESRM64103_Lecture13.qmd